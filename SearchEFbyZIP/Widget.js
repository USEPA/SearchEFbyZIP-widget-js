...
function(declare, BaseWidget,EFdownload,_config) {
  ...
  return declare([BaseWidget], {
    ...
    baseClass: 'jimu-widget-SearchEFbyZIP',
   ...
   startup: function() {
    ...
    _drawEFxml: function () {
        ...
        if (this.map.getLayer("graphicLayer_" + this.id)) {
            ...
            dojo.connect(graphiclayer, "onClick", function () { clickongraphic = true; });
        }
       ...
       //TD add to config
        ...
        var inputurl = efsearchurl + "postal_code/BEGINNING/" + searchtext + "/";
